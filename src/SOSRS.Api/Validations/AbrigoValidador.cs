...
public class AbrigoValidador : AbstractValidator<Abrigo>
{
    public AbrigoValidador()
    {
        ...
        //     .NotEmpty().WithMessage("O campo Chave Pix é obrigatório.")
        //     .NotNull().WithMessage("O campo Chave Pix é obrigatório.")
        //     .Length(3, 150).WithMessage("O campo Chave Pix deve ter entre 3 a 150 caracteres.");
